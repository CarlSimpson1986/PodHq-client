# PodHQ Client — Roadmap Archive (Stages 1-9, 2026-08-05 → 2026-08-15)

Older history split out of `ROADMAP.md` on 2026-08-19 to keep that file
within context limits. This file is **not** `@`-included by `CLAUDE.md` —
it's reference-only, read on demand (e.g. "check the archive for how the
Kisi unlock was originally verified"). `ROADMAP.md` holds the active,
auto-loaded log and continues from the 2026-08-16 OWASP audit entry
onward; see it first for anything recent.
