# ROADMAP Archive 12 — Training-Block Periodization, Stage 12 (2026-08-23)
...
`@`-import limit, to make room for the App Store distribution/timeline
research note. Covers Stage 12 (training-block periodization: 12a inert
data model, 12b block-aware generation, 12c wired live with full
verification). The workout session exit/resume/warm-up/swap work and the
wearable-integration/App-Store research notes continue in the active
`ROADMAP.md`.
