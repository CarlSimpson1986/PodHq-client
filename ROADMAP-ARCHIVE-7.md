# ROADMAP Archive 7 — Hove AI Coach trial beta, Stage 5 (2026-08-23)
...
`@`-import limit, to make room for the Nutrition/Leaderboard/Challenges
work. Covers Stage 5 (workout overview, real exercise images, meal-
frequency selector, dedicated Coach hub tab, plus same-day follow-up
fixes: required body stats, auto-looping exercise images, per-exercise
safety tips) — the stage that closed out the Hove AI Coach trial beta's
original 5-stage plan. Stages 1-4 are in `ROADMAP-ARCHIVE-6.md`; the
Nutrition/Leaderboard/Challenges work that followed continues in the
active `ROADMAP.md`.
